...
const DashboardPage = () => {
    ...
    if (loading && !stats) {
        return <DashboardLayout><div className="flex justify-center items-center h-64">Loading Dashboard...</div></DashboardLayout>;
    }
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-4">
                        ...
                        <div className="grid grid-cols-1 gap-3">
                            ...
                            <button onClick={() => navigate('/orders/new')} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors group">
                                <span className="font-semibold text-gray-700">Create New Order</span>
                                <ArrowRight size={18} className="text-gray-400 group-hover:text-blue-600" />
                            </button>
                            <button onClick={() => navigate('/products/new')} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors group">
